          ...
          <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm  dark:bg-gray-50">
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full sm:col-span-3">
                ...
                {showPassword ? (
                <FaRegEyeSlash
                  className="relative lg:ml-[93%] ml-[90%] bottom-5 transform -translate-y-1/2 h-5 w-5 cursor-pointer"
              ...
              <div className="col-span-full">
                ...
                <input
                  ...
                  className="w-full rounded-md focus:ring focus:ring-opacity-75  p-2 focus:ring-violet-400 focus:dark:ring-violet-600 border-2 shadow-xl dark:border-gray-300"
                />
                <h1 className="text-lg font-bold mt-5">Address</h1>
              </div>
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              ...
              <div className="col-span-full">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {registerSuccess && (
                    <p className="lg:text-xs md:text-md text-sm  font-bold bg-gradient-to-r from-red-700 via-red-700 to-red-700 inline-block text-transparent bg-clip-text">
                      {registerSuccess}
                    </p>
                  )}
                </div>
