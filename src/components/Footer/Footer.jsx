...
const Footer = () => {
  return (
    <div >
      <footer className=" relative h-full  px-4 divide-y bg-gray-700 dark:bg-gray-100 text-gray-100 dark:text-gray-800">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              ...
              <img className="lg:h-16 h-20 w-12  lg:w-16" src={logo} alt="" />
              </div>
